/****************************************************************************
** Meta object code from reading C++ file 'keyp.h'
**
...
#include <memory>
#include "../button/keyp.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'keyp.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject KeyPress::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_KeyPress.data,
    qt_meta_data_KeyPress,
    qt_static_metacall,
    nullptr,
    nullptr
} };
